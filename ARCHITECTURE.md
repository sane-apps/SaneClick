...
### Folder guidance and localization | Updated: 2026-09-07 | TTL: 90d

- Keep monitored-folder help visible with populated and empty lists. The signed runtime proved that the English string catalog can override a newer Swift defaultValue; validate displayed copy and update the existing catalog key across supported languages when changing that copy.
- Apple's [Finder Sync guide](https://developer.apple.com/library/archive/documentation/General/Conceptual/ExtensibilityPG/Finder.html) scopes contextual menus to monitored folders and their contents. Its [Smart Folder guide](https://support.apple.com/guide/mac-help/mchlp2804/mac) describes a list selected by criteria. Keep the guidance focused on adding the actual containing folder; this does not prove menu behavior in every Finder search view.
- Live English populated-folder proof: outputs/customer-ui/portfolio-20260907/recents-hint-proof.json. Other locales need visual review before broad localized UI clearance.
